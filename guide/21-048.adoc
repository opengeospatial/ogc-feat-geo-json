:Title: OGC Features and Geometries JSON Guide
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/{doc-type}/{standard}/{m_n}
|Internal reference number of this OGC(R) document:    21-048
