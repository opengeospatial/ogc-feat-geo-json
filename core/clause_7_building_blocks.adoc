...
All examples in this section use "Amersfoort / RD New" (\http://www.opengis.net/def/crs/EPSG/0/28992) as the coordinate reference system.
...
the same format or media type.  Named variations of a resource are called "prfoles".
