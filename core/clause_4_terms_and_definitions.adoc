...
primary geometry::
the geometry that the publisher considers as the most important spatial characteristic of a *feature* [<<ogc23-058r2,OGC API - Features - Part 5: Schemas>>]
...
the time instant or time interval that the publisher considers as the most important temporal characteristic of a *feature* [<<ogc23-058r2,OGC API - Features - Part 5: Schemas>>]
