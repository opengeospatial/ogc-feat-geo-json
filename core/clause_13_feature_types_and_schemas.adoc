...
|Dependency |<<rc_core>>
|Indirect Dependency |<<ogc23-058r2,OGC API - Features - Part 5: Schemas>>
|===
...
|===
^|*Requirement {counter:req-num}* |/req/{req-class}/{req}
^|A |If the JSON-FG root object is a feature or feature collection with a "featureSchema" member, all referenced schemas SHALL conform to <<ogc23-058r2,OGC API - Features - Part 5: Schemas>>.
|===
