...
[[OAFeat-5]] Open Geospatial Consortium (OGC). **OGC API - Features - Part 5/Common - Part 3: Schemas 1.0**. Edited by C. Portele, P. Vretanos. 2026. Available at https://docs.ogc.org/DRAFTS/23-058r1.html
