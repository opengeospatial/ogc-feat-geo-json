...
|Internal reference number of this OGC(R) document:    21-045r1
|Version: {m_n_o}
...
include::clause_6_introduction.adoc[]

include::clause_7_building_blocks.adoc[]

include::clause_8_core.adoc[]

include::clause_9_polyhedra.adoc[]

include::clause_10_prisms.adoc[]

include::clause_11_circular_arcs.adoc[]

include::clause_12_measures.adoc[]

include::clause_13_feature_types_and_schemas.adoc[]

include::clause_14_profiles.adoc[]

include::clause_15_jsonfg-api.adoc[]
