...
- The JSON Schema documents need to be updated to version 1.0.0.
...
- The reference to OGC API Features Part 5: Schemas in the References section should be updated to the published version.
