...
# resolved jsonfg-document schema

ajv validate -d building.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 

ajv validate -d fence.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 

ajv validate -d pylon.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 

ajv validate -d toronto-city-hall.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 

ajv validate -d cologne-cathedral.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 

ajv validate -d airports.json -s "../schemas/jsonfg-document.min.json" --spec=draft2020 --validateFormats=false --strict=true 
