...
The JSON-FG Standard specifies the following mandatory extensions to the GeoJSON format in its first version:
...
* Support for solids and prisms as geometry types for 3D;
...
NOTE: This section is for version 0.2 and needs to be updated to version 0.3.
...
| Name | Status | Remarks | Core ("place") | Core ("time") | 3D (Polyhedron) | 3D (Prism) | Feature Type | Schema | 
| ---- | ------ | ------- | :------------: | :-----------: | :-------------: | :--------: | :----------: | :----: |
| [ogc-checker](https://github.com/Geonovum-labs/ogc-checker) | Initial version | Validate JSON-FG using JSON Schema validation and additional tests. [Online validator](https://geonovum-labs.github.io/ogc-checker/) | X | X | X | X | X | X |
